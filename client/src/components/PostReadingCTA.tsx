...
export default function PostReadingCTA({ readingType }: { readingType?: string }) {
  ...
  return (
    <div className="mt-6 space-y-3">
      {/* A quiet landing for the moment after a reading. No specific
          tradition, no scripture, no deity. Just an invitation to let
          the reading settle before the next thing. */}
